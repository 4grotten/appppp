...
class MessengerChat(TimestampModel):
    ...
    members = models.ManyToManyField(User, through='ChatMember', related_name='messenger_chats')
...
class ChatMessage(TimestampModel):
    chat = models.ForeignKey(MessengerChat, on_delete=models.CASCADE, related_name='messages')
...
class BlockedChat(models.Model):
    ...
    blocked_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='blocked_chats')
