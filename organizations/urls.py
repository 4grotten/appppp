...
from .views.hotlink_views import (
    ...
    HotlinkItemsListUpdateView, CollectionLinksCreateView, CollectionLinksListView, CollectionLinkDestroyView
)
...
hotlink_urls = [
    ...
    path('hotlink_links/<int:pk>/', CollectionLinkDestroyView.as_view(), name='delete_hotlink_link'),
]
