...
def get_settings_login_device(username, password, proxy, wait=60, max_retry=0):
    ...
    if max_retry > 10:
        return {
            "uuids": {
                "uuid": "206ea907-d6ad-4d79-b2c0-d67e77e26b08",
                "phone_id": "d0eb57ab-9487-48f5-a709-fdce1b96e812",
                "device_id": "android-fde756e2092dfd25",
                "advertising_id": "9b658224-26c9-445a-a351-040ebf332ad1",
                "client_session_id": "28649e1b-d9c7-4aa4-9113-22833f51a8e2",
            },
            "cookies": {
                "mid": "YTW1CAABAAGONdMoG-5XR2Ifg6SF",
                "rur": '"CLN\\05446463092011\\0541662445711:01f7cde26c7253514a3ec72de4f6b5f9191a991655b567aa1ba31f43bd3da0a1287add60"',
                "shbid": '"1356\\05446463092011\\0541662445710:01f79d9db7c48ae29a2a7598096fc48a1c2d35857f0366cbf02057abd4bce55cca712b5f"',
                "shbts": '"1630909710\\05446463092011\\0541662445710:01f7da5378e42c05624700d1465c01010372a699762a7360518e0e1c3d705dec8cc59777"',
                "csrftoken": "Zf9chsmKkwSnHvXlDBdTnQyyRVQNKnCH",
                "sessionid": "46463092011%3AC9gwjq8w8HKE9R%3A16",
                "ds_user_id": "46463092011",
            },
            "last_login": 1630909711.7064524,
    ...
    if not result:
        max_retry += 1
        wait = wait + 60
        result = get_settings_login_device(
            username, password, wait=wait, max_retry=max_retry, proxy=proxy
        )
    return result
