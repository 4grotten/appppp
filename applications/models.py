...
class UserAppType(models.Model):
    ...
    category = models.ForeignKey(
        UserAppCategory, on_delete=models.CASCADE, related_name="types"
    )
...
class UserAppBanner(TimestampModel):
    image = models.ForeignKey(
        "common.File", on_delete=models.CASCADE, related_name="user_app_banners"
    )
...
class UserApp(TimestampModel):
    owner = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="owned_user_apps"
    )
    ...
    banners = models.ManyToManyField(
        UserAppBanner, blank=True, related_name="user_apps"
    )
    ...
    app_images = models.ManyToManyField(
        "common.File", blank=True, related_name="user_app_images"
    )
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=("user", "user_app"), name="unique_user_app_added_by_user"
            )
        ]
...
class UserAppBalance(models.Model):
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="user_app_referral_balance"
    )
...
class UserAppTransaction(TimestampModel):
    owner = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="app_sales_profits"
    )
    user_app_purchase = models.ForeignKey(
        UserAppPurchase, on_delete=models.CASCADE, related_name="referral_transactions"
    )
