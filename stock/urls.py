...
urlpatterns = [
    ...
    path('download_rental_info/<int:pk>/', DownloadRentalInfoAPIView.as_view(),
         name='download_rental_info'),

    path('download_ticket_info/<int:pk>/', DownloadTicketInfoAPIView.as_view(),
         name='download_ticket_info'),
