...
urlpatterns = [
    ...
    path('shop-items/<int:pk>/pin-organization/', PinOrganizationItemView.as_view(), name='pin-organization-item'),
    ...
    path('comments/chat/<int:pk>/assistant/', AssistantCommentChatCreateView.as_view(),
         name='assistant_comment_chat_create'),
    ...
    path('comments//item/<int:pk>/', CommentItemListCreateView.as_view(), name='comment_item_list'),
    path('comments/change/comments_disabled/', ItemChangeCommentsDisabledView.as_view(),
         name='comment_change_comments_disabled'),
