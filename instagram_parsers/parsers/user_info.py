...
def get_instagram_user_info(username: str):
    settings = {
        'uuids': {'phone_id': '6605a3d5-a2a7-44f2-b7b1-ba05c979572b', 'uuid': 'c24cfd46-dac3-4135-8064-d7453ee2f5ef',
                  'client_session_id': '27624802-1d50-4bfa-ab8e-ad046199e940',
                  'advertising_id': '73967dfc-1605-4b65-9e6a-7bc710d2ee1f', 'device_id': 'android-9adddd55865dc2c7'},
        'cookies': {'csrftoken': 'LwRgs1JTDTZWnOa0fetR0K3ALXXhmYHq', 'ds_user': 'apofi_z', 'ds_user_id': '45149694492',
                    'mid': 'X-MTIQABAAEzDuxYB6ZRM1JnMjaa', 'rur': 'RVA',
        ...
        'device_settings': {'app_version': '105.0.0.18.119', 'android_version': 28, 'android_release': '9.0',
                            'dpi': '640dpi', 'resolution': '1440x2560', 'manufacturer': 'samsung', 'device': 'SM-G965F',
