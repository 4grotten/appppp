...
from transactions.models import Balance, PayoutSystem, Recipient, Transaction
...
class TransactionService:
    ...
    def complete_transaction(
        ...
        coupons_ids: Union[list, None] = None,
    ) -> Transaction:
        ...
        if coupons_ids:
            ...
            CouponUsage.objects.bulk_create(coupon_usage)
