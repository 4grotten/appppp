...
WITHDRAWAL_ICON_MAP = {
    ...
    (Transaction.WITHDRAWAL, Transaction.UNDER_REVIEW): REQUEST_WITHDRAWAL_TYPE,
    (Transaction.WITHDRAWAL, Transaction.ACCEPTED): ACCEPTED_WITHDRAWAL_TYPE,
    (Transaction.WITHDRAWAL, Transaction.ACCEPTED_WITHDRAWAL): ACCEPTED_WITHDRAWAL_TYPE,
    (Transaction.WITHDRAWAL, Transaction.REJECTED): DECLINED_WITHDRAWAL_TYPE,
    (Transaction.WITHDRAWAL, Transaction.ERROR): DECLINED_WITHDRAWAL_TYPE
}