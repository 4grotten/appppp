...
MODELTRANSLATION_AVAILABLE_LANGUAGES = (
    "ru",
    "en",
    "tr",
    "de",
...
RE_CAPTCHA_SECRET_KEY = "6LcNJwIiAAAAAC_-XBCAMc3JGRi9hOcUyIWl6OkE"
...
IMAGEKIT_DEFAULT_CACHEFILE_BACKEND = "imagekit.cachefiles.backends.SourceFilePath"
...
SMSCRU_LOGIN = config("SMSCRU_LOGIN")
SMSCRU_PASSWORD = config("SMSCRU_PASSWORD")
...
GOOGLE_APPLICATION_CREDENTIALS = config(
    "GOOGLE_APPLICATION_CREDENTIALS", default="notasecret"
)
...
CELERY_TASK_ROUTES = {
    ...
    "organizations.tasks.delete_not_updated_posts_from_instagram": {
        "queue": "insta_low"
    },
    ...
    "organizations.tasks.update_login_device_settings": {
        "queue": "update_login_device"
    },
    "organizations.tasks.delete_expired_video_url": {"queue": "delete_expired_video"},
    "organizations.tasks.delete_expired_photo_and_posts": {
        "queue": "delete_expired_posts"
    },
...
INSTAGRAM_LOGIN_DEVICE_EXPIRE_DAYS = config(
    "INSTAGRAM_LOGIN_DEVICE_EXPIRE_DAYS", default=1, cast=int
)
INSTAGRAM_IMG_EXPIRE_DAYS = config("INSTAGRAM_IMG_EXPIRE_DAYS", default=3, cast=int)
INSTAGRAM_POSTS_UPDATE_BATCH_SIZE = config(
    "INSTAGRAM_POSTS_UPDATE_BATCH_SIZE", default=30, cast=int
)
...
if not DEBUG:
    SENTRY_DSN = config(
        "SENTRY_DSN",
        cast=str,
        default="https://9830f4ac6ea04f83aed2d7b2abdd24e5@o173421.ingest.sentry.io/5733313",
    )
    import sentry_sdk
