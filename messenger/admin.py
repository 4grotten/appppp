...
class MessengerChatAdmin(admin.ModelAdmin):
    list_display = ('id', 'chat_type', 'title', 'is_blocked_display', 'created_at', 'updated_at')
...
class ChatMessageAdmin(admin.ModelAdmin):
    list_display = ('id', 'chat', 'sender', 'short_text', 'is_sent', 'is_delivered', 'is_read', 'created_at')
