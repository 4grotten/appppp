...
class MessengerChatService:
    ...
    def sort_by(cls, queryset, sort_by: str, user=None):
        logger.info(f"[MESSENGER_FILTER] sort_by={sort_by}")
        ...
        if sort_by == "new":
            ...
            logger.info(f"[MESSENGER_FILTER] 'new' filter applied.")
            ...
            logger.info(f"[MESSENGER_FILTER] 'unread' filter applied. ")
            ...
            logger.info(f"[MESSENGER_FILTER] 'blocked' filter applied. Count after: ")
            ...
            logger.info(f"[MESSENGER_FILTER] 'groups' filter applied.")
        ...
        logger.info(f"[MESSENGER_FILTER] Final queryset count for sort_by={sort_by}")
        return queryset
